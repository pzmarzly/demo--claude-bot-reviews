...
See [claude-pr-review.yaml](./.github/workflows/claude-pr-review.yaml).

With Opus model, it takes about 2 minutes to review a trivial PR, and costs about $0.6 in tokens.
